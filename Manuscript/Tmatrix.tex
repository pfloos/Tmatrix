...
First, we study the excited states of the hydrogen molecule \ce{H2} upon dissociation.
...
\begin{figure*}
	...
	\caption{Singlet (left) and triplet (right) excitation energies (in \si{\eV}) of \ce{H2} as a function of the interelectronic distance $R_{\ce{H-H}}$ (in \si{\angstrom}) obtained at the FCI/cc-pVDZ (black), BSE@$G_0W_0$ (blue), and BSE@$G_0T_0$ (red) levels.}
\end{figure*}
%%% %%% %%% %%%
%%%%%%%%%%%%%%%%%%%%%%
