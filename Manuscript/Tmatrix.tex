...
Contrary to the $GW$ approximation which relies on the (two-point) dynamically-screened Coulomb potential $W$ computed from a particle-hole random-phase approximation (ph-RPA) problem to target charged excitations (\ie, ionization potentials and electron affinities), \cite{Hedin_1965,Aryasetiawan_1998,Onida_2002,Martin_2016,Reining_2017,Golze_2019} here we consider the $GT$ approximation where one employs the (four-point) $T$ matrix obtained from solving the particle-particle RPA (pp-RPA) equations.
...
In order to go beyond the static approximation, it is possible to consider a dynamical correction of the BSE (dBSE) within the Tamm-Dancoff approximation: \cite{Rohlfing_2000,Romaniello_2009b,Ma_2009a,Ma_2009b,Zhang_2013,Rebolini_2016,Olevano_2019,Loos_2020h,Authier_2020,Monino_2021}
\begin{equation}
\label{eq:LR-RPA}
	\begin{pmatrix}
...
Although one can potentially access double excitations within this formalism (due to the dynamical nature of the equations), here we rely on the perturbative scheme developed in Ref.~\onlinecite{Loos_2020h} in order to access corrected single excitations.
